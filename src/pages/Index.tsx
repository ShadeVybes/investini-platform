...
import heroImage from '@/assets/hero-investini.jpg';
        ...
        <div className="space-y-8">
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Notre équipe d'experts est là pour vous accompagner dans votre démarche d'investinissement.
            </p>
          </div>
          ...
          <div className="space-y-6 animate-fade-in-up">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">nassim.ceo@investini.tn</p>
              </div>
            </div>
  ...
  const texts = {
    fr: {
      ...
      hero: {
        ...
        description: 'La plateforme qui révolutionne la rencontre entre entrepreneurs visionnaires et investinisseurs qualifiés. Simplifiez votre levée de fonds avec l\'IA.',
      ...
      problem: {
        ...
        challenges: [
          { title: 'Difficulté d\'accès aux investinisseurs', desc: 'Trouver les bons contacts prend des mois' },
      ...
      solution: {
        title: 'investini révolutionne votre levée de fonds',
        features: [
          { icon: Brain, title: 'Matching IA Intelligent', desc: 'Algorithme qui connecte automatiquement votre projet aux investinisseurs pertinents selon vos critères.' },
          ...
          { icon: MessageCircle, title: 'Messagerie Sécurisée', desc: 'Communication chiffrée avec vos investinisseurs potentiels et gestion des NDA.' },
      ...
      powerfulFeatures: {
        ...
        subtitle: 'investini ne se contente pas de connecter. Il propulse les idées vers leur réalité.',
        features: [
          { 
            icon: Brain, 
            title: 'Matching Intelligent avec IA', 
            desc: 'Associe automatiquement votre projet aux investinisseurs les plus pertinents selon le secteur, la maturité, le montant visé et les précédents investinissements.',
            badge: '🔥 Intérêt élevé'
          },
          { 
            icon: FolderOpen, 
            title: 'Dossier d\'investinissement intelligent', 
          ...
          { 
            ...
            desc: 'Discussion instantanée avec les investinisseurs intéressés, historique centralisé et notifications intelligentes.',
            badge: '💬 Actif'
          },
          { 
            icon: BarChart3, 
            title: 'Suivi de vos performances & KPIs', 
            desc: 'Tableau de bord animé avec statut des demandes, taux de réponse, montant levé vs cible et feedback investinisseurs.',
            badge: '📊 Analytique'
          }
        ]
      },
      future: {
        title: 'Vision Future d\'investini',
        subtitle: 'L\'avenir de l\'investinissement décentralisé',
        roadmap: [
          { date: 'Q1 2026', title: 'Signature Web3', desc: 'Contrats intelligents pour les accords d\'investinissement' },
          { date: 'Q2 2026', title: 'Lancement international', desc: 'Expansion sur de nouveaux marchés européens' },
          { date: 'Q3 2026', title: 'Nouveaux produits IA', desc: 'Lancement de solutions IA avancées pour l\'investinissement' }
        ]
      },
      stats: {
        title: 'investini en chiffres',
        ...
        items: [
          ...
          { value: '350+', label: 'investinisseurs actifs', suffix: '' },
      ...
      testimonials: {
        ...
        items: [
          { name: 'Amira Ben Salah', role: 'CEO, TechFlow Tunisie', content: 'Grâce à investini, j\'ai levé 500,000 TND en 3 mois. Le matching IA est bluffant !', rating: 5 },
      ...
      cta: {
        ...
        subtitle: 'Rejoignez les entrepreneurs qui réussissent avec investini',
        entrepreneur: 'Je suis Entrepreneur',
        investor: 'Je suis investinisseur'
      }
    },
    en: {
      nav: {
      ...
      solution: {
        title: 'investini revolutionizes your fundraising',
        features: [
      ...
      powerfulFeatures: {
        ...
        subtitle: 'investini doesn\'t just connect. It propels ideas towards their reality.',
        features: [
          { 
            icon: Brain, 
      ...
      testimonials: {
        title: 'They trust us',
        items: [
          { name: 'Amira Ben Salah', role: 'CEO, TechFlow Tunisia', content: 'Thanks to investini, I raised 500,000 TND in 3 months. The AI matching is amazing!', rating: 5 },
      ...
      cta: {
        ...
        subtitle: 'Join entrepreneurs who succeed with investini',
    ...
    <div className="min-h-screen bg-gradient-hero">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex-shrink-0">
              <h1 className="text-2xl font-bold text-gradient">investini</h1>
            </div>
      ...
      <section id="demo" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="animate-fade-in-up">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-gradient">Découvrez investini en action</h2>
            <div 
            ...
            >
              ...
              <div className="absolute bottom-8 left-8 right-8 text-white">
                ...
                <p className="text-sm opacity-90">Découvrez comment investini transforme votre levée de fonds</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-glass border-t border-glass-border">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div>
              <h3 className="text-2xl font-bold text-gradient mb-4">investini</h3>
              <p className="text-muted-foreground mb-4">
                La plateforme qui connecte les entrepreneurs aux investinisseurs.
              </p>
          ...
          <div className="border-t border-glass-border pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-muted-foreground text-sm">
              © 2024 investini. Tous droits réservés.
            </p>
