                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  >
                    <div className="flex items-center mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Je cherche des investinisseurs</p>
                      </div>
                    </div>
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      ...
                      <li className="flex items-center">
                        <CheckCircle className="h-4 w-4 mr-2 text-primary" />
                        Matching IA avec investinisseurs
                      </li>
                      <li className="flex items-center">
                        <CheckCircle className="h-4 w-4 mr-2 text-primary" />
                  ...
                  >
                    <div className="flex items-center mb-4">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold">investinisseur</h3>
          ...
          {currentStep === 3 && formData.role === 'investor' && (
            <>
              <CardHeader className="text-center pb-6">
                ...
                <p className="text-muted-foreground">
                  Votre compte investinisseur est presque prêt
                </p>
              </CardHeader>
              ...
              <CardContent className="text-center space-y-6">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold">Accès investinisseur activé</h3>
                  <p className="text-muted-foreground">
